...
import { Home, Users, FileText, LogOut, Menu, User as UserIcon, CreditCard, Bell, MoreVertical } from 'lucide-react'
...
export function CoordinatorSidebar({ className }: CoordinatorSidebarProps) {
  ...
  const routes = [
    ...
    },
    {
      label: 'Facilitadores',
      icon: Users,
      href: '/coordinator-dashboard/facilitators',
    },
    {
      label: 'Reportes',
      icon: FileText,
      href: '/coordinator-dashboard/reports',
    },
  ]
          ...
          {routes.map((route) => (
            <Link
              ...
              className={cn(
                ...
                pathname === route.href ? "bg-gray-200 dark:bg-gray-700" : "transparent"
              )}
            >
            ...
            <Button variant="ghost" className="w-full justify-start h-auto p-2 hover:bg-gray-200 dark:hover:bg-gray-700">
              <div className="flex items-center gap-3 w-full">
                ...
                <div className="flex flex-col items-start text-left overflow-hidden flex-1">
                  ...
                  <span className="truncate text-xs text-gray-500 font-normal">Coordinador</span>
                </div>

...
import { Home, Users, FileText, LogOut, Menu, User as UserIcon, MoreVertical, UserCog } from 'lucide-react'
...
export function DirectorSidebar({ className }: DirectorSidebarProps) {
  ...
  const routes = [
    ...
    },
    {
      label: 'Coordinadores',
      icon: UserCog,
      href: '/director-dashboard/coordinators',
    },
    {
      label: 'Facilitadores',
      icon: Users,
      href: '/director-dashboard/facilitators',
    },
    {
      label: 'Reportes',
      icon: FileText,
            ...
            <Button variant="ghost" className="w-full justify-start h-auto p-2 hover:bg-gray-200 dark:hover:bg-gray-700">
              <div className="flex items-center gap-3 w-full">
                ...
                <div className="flex flex-col items-start text-left overflow-hidden flex-1">
                  ...
                  <span className="truncate text-xs text-gray-500 font-normal">Director</span>
                </div>

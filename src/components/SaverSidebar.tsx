...
import { Users, LogOut, Menu, MoreVertical, User as UserIcon, Bell, CreditCard } from 'lucide-react'
import { User } from '@supabase/supabase-js'
import { UpdateProfileDialog } from './UpdateProfileDialog'

interface SaverSidebarProps {
  className?: string
}
...
export function SaverSidebar({ className }: SaverSidebarProps) {
            ...
            <Button variant="ghost" className="w-full justify-start h-auto p-2 hover:bg-gray-200 dark:hover:bg-gray-700">
              <div className="flex items-center gap-3 w-full">
                ...
                <div className="flex flex-col items-start text-left overflow-hidden flex-1">
                  ...
                  <span className="truncate text-xs text-gray-500 font-normal">Ahorrador</span>
                </div>
